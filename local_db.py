...
def seed_manual_agencies():
    ...
    entries = [
        ...
        ("다살림재가노인지원서비스센터",    "safe_plus", "2026-06-15", "2026-12-31",   5, "6월 신규 계약"),
        ("영월군청",                    "basic",     "2026-06-15", "2026-12-31",  20, "6월 신규 계약"),
        ("계양구청",                    "safe_plus", "2026-06-15", "2026-12-31",  50, "6월 신규 계약"),
        ("연수구청",                    "safe",      "2026-06-15", "2026-12-31",  30, "6월 신규 계약"),
        ("세종사회서비스원",              "safe",      "2026-07-01", "2026-12-31",   0, "7월 시작 예정 (대상자 등록)"),
        ("인천사회서비스원",              "safe",      "2026-07-01", "2026-12-31",   0, "7월 시작 예정 (대상자 등록)"),
    ]
    conn = get_connection()
